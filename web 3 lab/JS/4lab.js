...
var data = prompt("Количество символов в лит. произведении:", 0);
...
var obj1 = {
    countries: [
        ["Италия"/*[0]*/, "Рим", "Евразия", "Европа", -2, "итальянская лира", 
          ["Альпы", "Пальмария", "Апеннинский полуостров", "Комо", "Тальяменто"], 
          [["Джованни Верга", "Жизнь среди полей"/*[7][0][1]*/, 1880], ["Анна Виванти", "Цирцея", 1912], ["Джузеппе Понтиджа", "Рождённые дважды", 2000]],
...
document.body.innerHTML += '<h1>Вывести информацию о государствах объекта obj1 с помощью метода outCountries</h1>';
obj1.outCountries();

document.body.innerHTML += '<h1>Вывести имеющуюся информацию о государствах объекта obj2 с помощью метода outCountries объекта obj1</h1>';
...
document.body.innerHTML += '<h1>Отобразить изменения в браузере с помощью метода outCountries объекта obj1</h1>';
obj1.outCountries();

document.body.innerHTML += '<h1>Показать как (не)изменились данные поля countries объекта obj2</h1>';
obj1.outCountries.call(obj2);